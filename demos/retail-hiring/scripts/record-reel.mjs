 ...
 * assets/retail-hiring-demo.mp4 (1920×1080 @ 30fps, with voiceover + music).
 *
...
const OUT_MP4 = join(DEMO_DIR, 'assets', 'retail-hiring-demo.mp4');
const FPS = 30;
...
const work = mkdtempSync(join(tmpdir(), 'retail-reel-'));
