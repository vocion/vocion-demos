#!/usr/bin/env python3
"""Seed *processed* applicant business objects for the Retail Hiring demo pages — v2, depth.
...
Usage: python3 seed-processed-applicants.py | docker exec -i vocion-postgres \
         psql -U postgres -d vocion_retail_hiring
"""
import json
import pathlib

HERE = pathlib.Path(__file__).resolve().parent
DATA = HERE.parent / "workspace" / "retail-hiring" / "data"
ORG = "proj-3a44f54e-f3a1-4045-96cd-de80e5f3b99d"

MANAGERS = {
    "riverside": "P. Kealoha", "lakeside": "R. Santos", "midtown": "M. Ikaika",
    "harborview": "L. Fonoti", "eastgate": "D. Choy", "westfield": "T. Agbayani",
}
...
EDGES = [
    ...
    {
        "id": "EDGE-CONFLICT", "name": "Dario Vela — Deli Clerk (Harborview)",
        "role_applied": "Deli Clerk", "level": "level-2", "store_preference": "harborview",
        "source": "website", "availability": "weekdays only, ends 3pm",
        "plant_based_ack": "acknowledged", "smokes_or_vapes": "no",
        "body": "RESUME\nDario Vela · Harborview, HI\nExperience: 3 years deli counter + kitchen prep, food-handler card, register work.\nAPPLICATION ANSWERS\nStore preference: Harborview\nAvailability: weekdays only, must leave by 3pm (childcare)\nWhy Retail Hiring Workforce: closest store to home, love the deli.",
        "edge": "scheduling-conflict",
        "pin": 71,
        "note": "Experience is exactly the role — but the Harborview deli's open need is weekend closing shifts, and the stated availability is weekday-until-3pm. Routed at 71 with the conflict called out; the manager decides whether a schedule can be built.",
    },
    {
        "id": "EDGE-NEARMISS", "name": "Tomas Iwata — Sales Associate (Eastgate)",
        "role_applied": "Sales Associate", "level": "level-2", "store_preference": "eastgate",
        "source": "indeed", "availability": "evenings + weekends",
        "plant_based_ack": "acknowledged", "smokes_or_vapes": "no",
        "body": "RESUME\nTomas Iwata · Aiea, HI\nExperience: 18 months movie-theater concessions — register, food handling, closing duties.\nAPPLICATION ANSWERS\nStore preference: Eastgate\nAvailability: evenings and weekends\nWhy Retail Hiring Workforce: switching to daytime retail long-term, shopping here since high school.",
        "edge": "near-miss",
        "pin": 68,
        "note": "Two points under threshold: real register and food-handling history, but short tenure and no grocery or deli exposure. Held in the 60–69 second-look band — a manager can reopen this with one click if Eastgate is short-staffed.",
    },
    {
        "id": "EDGE-DUP-A", "name": "Keila Moreno — Deli Clerk (Midtown)",
        "role_applied": "Deli Clerk", "level": "level-2", "store_preference": "midtown",
        "source": "indeed", "availability": "full-time, any shift",
        "plant_based_ack": "acknowledged", "smokes_or_vapes": "no",
        "body": "RESUME\nKeila Moreno · Lakeside, HI\nExperience: 2 years café barista + food prep, food-handler card, customer service award.\nAPPLICATION ANSWERS\nStore preference: Midtown\nAvailability: full-time, any shift\nWhy Retail Hiring Workforce: plant-based at home, want work to match.",
        "edge": None, "pin": 77,
        "note": "Café prep and customer-facing history line up with the deli role; availability is fully open. Routed to Midtown.",
    },
    {
        "id": "EDGE-DUP-B", "name": "Keila Moreno — Deli Clerk (Midtown)",
        "role_applied": "Deli Clerk", "level": "level-2", "store_preference": "midtown",
