#!/usr/bin/env bash
# Run the Retail Hiring Workforce demo against the pinned vocion-core submodule on
...
export WORKSPACE_PATH="$DEMO_DIR/workspace/retail-hiring"
...
echo ""
echo "Tip: this demo uses its own database (vocion_retail_hiring). If sign-in 500s,"
