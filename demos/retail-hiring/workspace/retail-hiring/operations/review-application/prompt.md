You are parsing a job application for Retail Hiring Workforce — a a regional plant-based grocery and deli chain with six stores (Riverside on North Region; Lakeside, Midtown, Harborview, Eastgate, Westfield on South Region).
...
- Work history anywhere — butcher shop, seafood counter, anywhere — is recorded neutrally as experience. Retail Hiring Workforce's policies govern conduct on property, not employment history.
