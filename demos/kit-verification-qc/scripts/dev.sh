#!/usr/bin/env bash
# Run the the manufacturer demo against the pinned vocion-core submodule on
...
export WORKSPACE_PATH="$DEMO_DIR/workspace/kit-verification-qc"
...
echo ""
echo "Tip: this demo uses its own database (vocion_kit_verification_qc). If sign-in 500s,"
