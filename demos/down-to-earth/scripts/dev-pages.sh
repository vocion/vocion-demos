#!/usr/bin/env bash
# Run the DTE demo against the TOP-LEVEL vocion-core checkout (branch
...
#
# The vocion_dte database has been migrated forward to main's schema; the
...
export WORKSPACE_PATH="$DEMO/workspace/down-to-earth"
