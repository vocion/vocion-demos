...
unverified). Context: Havis — detect wrong or missing parts in a package assembly
...
1. **Prepare and upload the dataset**
   ...
   - Store raw images in S3. (Havis already has these organized by template id, Good/Bad.)
2. **Label the images**
...
## Open questions to bring to Havis
